...
import com.cvr.discordbot.core.listeners.MessageEventListener;
...
public class DiscordBotConfiguration {
    ...
    JDA getApi( @Qualifier( "cleanCommand" ) final CleanCommand cleanCommand, @Qualifier( "messageEventListener" ) final MessageEventListener messageEventListener) {
    	...
    	jda.upsertCommand(Commands.slash("clean", "ATENCIÓN: Este comando BORRA todo el contenido del hilo \"Temas recientes\"").setContexts(InteractionContextType.GUILD)).queue();
